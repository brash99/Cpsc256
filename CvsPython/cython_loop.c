...
static PyObject *__pyx_pw_11cython_loop_1run_loop(PyObject *__pyx_self, PyObject *__pyx_arg_NUMBER) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_loop.run_loop", __pyx_clineno, __pyx_lineno, __pyx_filename);
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_s); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 */
  ...
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_run_loop, __pyx_t_1) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
